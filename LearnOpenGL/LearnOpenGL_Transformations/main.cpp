...
int main()
{
	...
	// ------------------------------------
	Shader ourShader("texture/5.1.texture.vs", "texture/5.1.texture.fs");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		trans1 = glm::scale(trans1, glm::vec3(abs(sinf((float)glfwGetTime())), abs(sinf((float)glfwGetTime())), abs(sinf((float)glfwGetTime()))));
